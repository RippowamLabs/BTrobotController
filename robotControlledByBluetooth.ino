...
void setup() {
  Serial.begin(9600);
  Serial.println("ArduDroid 0.12 Alpha by TechBitar (2013) and Adafruit Motor shield");
  Serial.flush();
  //adafruit motorshield code
...
void set_digitalwrite(int pin_num, int pin_value)
{
  ...
  case 5:
    ...
    // add your code here     
    //adafruit motorshield code
     //drag left wheel for half a second
  ...
  case 2:
    ...
    digitalWrite(2, pin_value); 
         //adafruit motorshield code
     //drag left wheel for half a second
     LeftMotor1->setSpeed(125);
     RightMotor2->setSpeed(5);
     delay(525);
     //resume regular speed
     LeftMotor1->setSpeed(110);
      RightMotor2->setSpeed(110);
